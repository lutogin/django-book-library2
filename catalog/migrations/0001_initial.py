...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Science Fiction, French Poetry etc.)', max_length=256)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[{'Maintenance', 'm'}, {'On loan', 'o'}, {'a', 'Available'}, {'r', 'Reserved'}], default='m', help_text='Book availability', max_length=1)),
